...
# ===========================================================================
#
# Created: 2022-09-03 Y. Schumann
#
# Helper script to build and push alpine no-ip image for amd64 and arm64
#
# ===========================================================================
...
helpMe() {
    echo "
    Helper script to build Alpine no-ip image for amd64 and arm64,
...
IMAGE_NAME=starwarsfan/alpine-noip
DIGEST_AMD64=''
DIGEST_ARM64=''
DIGEST_ARMv7=''
